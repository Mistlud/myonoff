...
$requiredPaths = @(
    ...
    'mds\MyOnOff_Final_Handoff_Additional_Requirements.md',
    'mds\MyOnOff_Latest_Validation_Notes.txt',
    ...
    'src\MyOnOff.DesktopController\Assets\MyOnOff.ico',
    'android\gradlew.bat',
...
$requiredSourceContracts = @(
    ...
    @{ Path = 'src\MyOnOff.DesktopController\MyOnOff.DesktopController.csproj'; Text = '<ApplicationIcon>Assets\MyOnOff.ico</ApplicationIcon>' },
    @{ Path = 'android\app\src\main\AndroidManifest.xml'; Text = 'android:icon="@mipmap/ic_launcher"' },
    @{ Path = 'scripts\build-android.ps1'; Text = "'artifacts\android'" },
    @{ Path = 'scripts\build-android.ps1'; Text = "'gradlew.bat'" },
